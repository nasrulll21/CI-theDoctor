...
<script src="<?=base_url('assets/js/lib/jquery/jquery.min.js');?>"></script>
    ...
    <script src="<?=base_url('assets/js/lib/morris-chart/dashboard1-init.js');?>"></script>


	<script src="<?=base_url('assets/js/lib/calendar-2/moment.latest.min.js');?>"></script>
    <!-- scripit init-->
    <script src="<?=base_url('assets/js/lib/calendar-2/semantic.ui.min.js');?>"></script>
    <!-- scripit init-->
    <script src="<?=base_url('assets/js/lib/calendar-2/prism.min.js');?>"></script>
    <!-- scripit init-->
