            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="nav-label">Data Kasir</li>
                        <li><a class="has-arrow" href="#" aria-expanded="false"><i class="fa fa-bar-chart"></i><span class="hide-menu">Pelayanan</span></a>
                            <ul aria-expanded="false" class="collapse">
                            <!-- Admin/periksa/laboratorium
                                 Admin/periksa/radiologi
                                 Admin/periksa/operasi  -->

                                <li> <a href="<?=base_url('Admin/laboratorium');?>"><i class="fa fa-envelope"></i><span class="hide-menu"> Kasir</span></a></li>
                                <li> <a href="<?=base_url('Admin/radiologi');?>"><i class="fa fa-envelope"></i><span class="hide-menu">Jenis Pemeriksaan</span></a></li>
                                <li> <a href="<?=base_url('Admin/operasi');?>" ><i class="fa fa-envelope"></i><span class="hide-menu"> Data Obat</span></a></li>
                                <li> <a href="<?=base_url('Admin/operasi');?>" ><i class="fa fa-envelope"></i><span class="hide-menu"> Ruangan</span></a></li>
                            </ul>
                        </li>
