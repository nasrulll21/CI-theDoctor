    ...
    <div class="error-page" id="wrapper">
        <div class="error-box">
            <div class="error-body text-center">
                ...
                <a class="btn btn-info btn-rounded waves-effect waves-light m-b-40" href="<?=base_url('admin/');?>">Back to home</a> </div>
            <footer class="footer text-center">&copy; 2018 The Doctor Corp.</footer>
        </div>
    </div>
    <!-- End Wrapper -->
    <!-- All Jquery -->
